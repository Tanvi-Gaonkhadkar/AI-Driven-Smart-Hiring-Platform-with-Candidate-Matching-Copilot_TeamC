...
# ----------------------------------------------------------
# CHECK FOR SHARED AI INTERVIEW LINK
# ----------------------------------------------------------

shared_interview_id = st.query_params.get("interview_id")

is_shared_interview = shared_interview_id is not None
...
if is_shared_interview:

    try:
        interview_id = int(shared_interview_id)
    ...
    if interview is None:
        st.error("This interview link is invalid or no longer available.")
        st.stop()
